 ...
 * UIKit menu walker
 */
class UIKit_Menu_Walker extends Walker_Nav_Menu {
	...
	*/
	public static function fallback( $args ) {
		if ( current_user_can( 'manage_options' ) ) {
			...
			extract( $args ); //phpcs:ignore -- extract discouraged
			...
			$fb_output .= '>';
			$fb_output .= '<li><a href="' . admin_url( 'nav-menus.php' ) . '">' . __( 'Add a menu', 'host-tools' ) . '</a></li>';
			$fb_output .= '</ul>';
